package com.yhl.demoeurekaconsumer1;

import com.yhl.demoeurekaconsumer1.utils.HttpClientWithBasicAuth;
...
public class DemoEurekaConsumer1Application {
    ...
    public static void main(String[] args) { SpringApplication.run(DemoEurekaConsumer1Application.class, args);
