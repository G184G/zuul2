package com.yhl.demoeurekaconsumer1.utils;

import com.yhl.demoeurekaconsumer1.DemoEurekaConsumer1Application;
...
public class HttpClientWithBasicAuth {
    ...
    private String getHeader(String UserName, String Password) {
        ...
        String auth = UserName + ":" + Password;//使用Base64将auth进行加密
